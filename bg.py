...
def find_newest(path):
    ...
    return Nmaxelements(paths, 6)

# Copy pics to another folder!
def copy():
    files = find_newest(r'C:\Users\cguthrie\AppData\Local\Packages\Microsoft.Windows.ContentDeliveryManager_cw5n1h2txyewy\LocalState\Assets')
    for file in files:
